...
const WillYouBePaidPercentage: React.FC<{
  ...
  return (
    <>
      <Text
        ...
        mr="auto"
      >
        Will [you] be paid a percentage of any profits or royalties that [artist
        first name makes] from [song name]?
      </Text>
...
export default WillYouBePaidPercentage;
